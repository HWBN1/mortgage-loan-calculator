...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-lg overflow-hidden w-2/3">
        ...
        <div class="p-4">
            ...
            <p><strong>Effective Interest Rate:</strong> {{ number_format($effectiveInterestRate, 2) }}% (after extra repayments)</p>
        </div>
                ...
                <tbody>
                    @foreach ($extraRepaymentSchedule as $entry)
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ number_format($entry['ending_balance_after_extra_repayment'], 2) }}</td>
                            <td class="border px-4 py-2">{{ number_format($entry['remaining_loan_term_after_extra_repayment'], 2) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
